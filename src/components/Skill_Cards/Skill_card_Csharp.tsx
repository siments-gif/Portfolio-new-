...
import Csharp_logo from '../../assets/Skills_Logo/Csharp_icon.png'
...
const Skill_card_Csharp = (props: Props) => {
  return (
    <article className='flex flex-col max-w-[1240px] rounded-lg items-center space-y-7 flex-shrink-0 w-screen
        ...
        <div className='px-0 md:px-10'>
            <h4 className='text-4xl font-light font-serif tracking-wider'>C-Sharp</h4>
...
export default Skill_card_Csharp