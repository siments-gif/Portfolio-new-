...
import Html_logo from '../../assets/Skills_Logo/HTML5_Logo_512px.png'
...
const Skill_card_HTML = (props: Props) => {
  return (
    <article className='flex flex-col max-w-[1240px] rounded-lg items-center space-y-7 flex-shrink-0 w-screen
        ...
        <div className='px-0 md:px-10'>
            <h4 className='text-4xl font-light font-serif tracking-wider'>Html</h4>
...
export default Skill_card_HTML